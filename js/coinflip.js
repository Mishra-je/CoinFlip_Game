...
function UpdateContractInfo() {
  ...
  web3.eth.getBalance(contractAddress, function(error, result) {
    if (!error) {
      ...
      $('#contractInfo').html('Contract Address: <a href="' + contractAddress + '" target="_blank">' + contractAddress + '</a> / Contract Balance: ' + result / 1000000000000000000 + ' ethers / Total Bets: ' + totalGameCount);
	  return true;
